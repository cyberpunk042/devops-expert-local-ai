---
description: Stop minimizing, compressing, and conflating -> Model keeps merging separate requirements into one, rushing to present designs before understanding, and asking questions the user already answered
---
